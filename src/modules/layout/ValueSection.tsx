import { Package, CalendarCheck, MapPin, AlertTriangle, Check } from 'lucide-react';
        ...
        >
          <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
            ...
            <div>
              ...
              >
                ...
                retiran exclusivamente en nuestro taller en Nagarote. No arriesgamos el trabajo
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            {features.map(item => (
              ...
              >
                <Check size={16} style={{ color: '#D4A96A', flexShrink: 0 }} />
                {item}
              </div>
            ))}
          </div>
