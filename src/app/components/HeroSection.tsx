import { ArrowRight, ShieldCheck, Sparkles, Package } from 'lucide-react';
...
const badges = [
  { icon: <ShieldCheck size={14} />, label: '100% Artesanal' },
  { icon: <Package size={14} />, label: 'Empaque Rígido' },
  { icon: <Sparkles size={14} />, label: 'Diseños Únicos' },
];
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
          ...
          >
            <Sparkles size={11} />
            Repostería Artesanal · Nagarote, Nicaragua
          </div>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', paddingTop: 4 }}>
            {badges.map(b => (
              ...
              >
                <span style={{ color: '#B07D4A' }}>{b.icon}</span>
                {b.label}
              </div>
            ))}
          </div>
        ...
        >
          ...
          <img
            ...
            style={{
              ...
              position: 'relative',
              zIndex: 1,
              boxShadow: '0 32px 80px rgba(28,25,23,0.12)',
            }}
          />
          {/* Floating card */}
          <div
